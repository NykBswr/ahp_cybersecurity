...
@section('dashboard')
    ...
    <div class="relative max-h-[65vh] overflow-x-auto overflow-y-auto rounded-xl shadow-md">
    ...
    <div class="mt-10 flex flex-row justify-between">
        <div class="flex flex-row">
            <a href="/dashboard/criteriaWeight">
                <div class="gradcolor mr-2 rounded-lg bg-dark px-6 py-2 text-lg font-semibold text-white hover:text-white">
                    Back
                </div>
            </a>
