<div id="criteriaCalculation" class="content">
    ...
    @if ($consistencyIndex / $ratioIndex >= 0 && $consistencyIndex / $ratioIndex <= 1)
        <h1 class="mb-3 text-lg font-medium text-dark">
            Because the Consistency Ratio (CR) value is in the range 0 to 1, the comparison given for the criteria
            is
            consistent.
        </h1>
    @else
        <h1 class="mb-3 text-lg font-medium text-red-500">
            Given the Consistency Ratio (CR) outside the 0 to 1 range, a reassessment of criteria comparisons is
            advised
            for
