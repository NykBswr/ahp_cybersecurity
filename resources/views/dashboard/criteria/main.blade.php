                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        <div id="popup-modal" tabindex="-1"
                            ...
                            <div class="relative h-auto w-auto p-4">
                                <div class="relative rounded-lg bg-white shadow">
                                    {{-- <button type="button"
                                            class="absolute end-2.5 top-3 ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-dark hover:bg-gray-100 hover:text-dark"
